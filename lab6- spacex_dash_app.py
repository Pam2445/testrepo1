...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.P(html.Strong("Payload range (Kg):")),
...
@app.callback(Output(component_id='success-pie_chart',component_property='figure'),
...
def scatter(entered_site,payload):
    ...
    if entered_site=='ALL':
        fig=px.scatter(filtered_df,x='Payload Mass(kg)',y='class',color='Booster Version Category',title= 'Launch outcome vs. Payload Mass')
        fig.update_layout(
            xaxis_tittle="Payload Mass (kg)",
            yaxis_title="Class:Failure = 0, Success = 1",
            legend_title="Booster Version Category")
        fig.update_traces(marker=dict(size=12, line = dict(width=2,color='DarkSlateGrey')),selector=dict(mode='markers'))
        
        return fig
    else:
         fig=px.scatter(filtered_df[filtered_df['Launch Site']==entered_site],x='Payload Mass(kg)',y='class',color='Booster Version Category',title= 'Launch outcome vs. Payload Mass')
         fig.update_layout(
            xaxis_tittle="Payload Mass (kg)",
            yaxis_title="Class:Failure = 0, Success = 1",
            legend_title="Booster Version Category")
